              ...
              {users.length > 0 && (
                <div className="p-4 border-b border-[rgb(var(--color-border))]">
                  ...
                  {users.map((user) => (
                    ...
                    >
                      <img
                        src={user.avatar_url || `https://muktoverse.vercel.app/asset/images/disorder_favicon.png`}
              ...
              {posts.length > 0 && (
                <div className="p-4">
                  ...
                  {posts.map((post) => (
                    ...
                    >
                      <img
                        src={post.profiles?.avatar_url || `https://muktoverse.vercel.app/asset/images/disorder_favicon.png`}
                        className="w-10 h-10 rounded-full flex-shrink-0 object-cover"
                        alt=""
                      />
                      <div className="flex-1 min-w-0">
