    ...
    <div className="flex space-x-4 p-4 overflow-x-auto scrollbar-hide bg-[rgb(var(--color-surface))] border-b border-[rgb(var(--color-text-secondary))]">
      ...
      {statusUsers.map((statusUser) => (
          ...
          >
            <div className="relative w-16 h-16 rounded-full">
              <img 
                src={statusUser.avatar_url || `https://muktoverse.vercel.app/asset/images/disorder_favicon.png`}
                className="w-full h-full rounded-full object-cover p-[2px] bg-[rgb(var(--color-surface))] relative z-10"
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full p-3 z-30">
        ...
        >
          <img 
            src={currentUser.avatar_url || `https://muktoverse.vercel.app/asset/images/disorder_favicon.png`}
